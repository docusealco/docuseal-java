...
public class AsyncRawDocusealClient {
     ...
     * The API endpoint provides the ability to retrieve a list of available document templates.
     */
    public CompletableFuture<DocusealClientHttpResponse<TemplateList>> getTemplates(RequestOptions requestOptions) {
     ...
     * The API endpoint provides the ability to retrieve a list of available document templates.
     */
    public CompletableFuture<DocusealClientHttpResponse<TemplateList>> getTemplates(GetTemplatesParams request) {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new DocusealClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, TemplateList.class), response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
                    future.completeExceptionally(new DocusealClientApiException(
                            "Error with status code " + response.code(), response.code(), errorBody, response));
                    return;
                } catch (JsonProcessingException e) {
                    future.completeExceptionally(
                            new DocusealClientException("Failed to deserialize response: " + e.getMessage(), e));
                } catch (IOException e) {
                    future.completeExceptionally(
                            new DocusealClientException("Network error executing HTTP request", e));
                }
            }
     ...
     * The API endpoint provides the functionality to retrieve information about a document template.
     */
    public CompletableFuture<DocusealClientHttpResponse<Template>> getTemplate(int id, RequestOptions requestOptions) {
     ...
     * The API endpoint provides the functionality to retrieve information about a document template.
     */
    public CompletableFuture<DocusealClientHttpResponse<Template>> getTemplate(int id, GetTemplateParams request) {
     ...
     * The API endpoint provides the functionality to retrieve information about a document template.
     */
    public CompletableFuture<DocusealClientHttpResponse<Template>> getTemplate(
     ...
     */
    public CompletableFuture<DocusealClientHttpResponse<TemplateUpdateResult>> updateTemplate(int id) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new DocusealClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, TemplateUpdateResult.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<DocusealClientHttpResponse<TemplateArchiveResult>> archiveTemplate(int id) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new DocusealClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, TemplateArchiveResult.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * The API endpoint provides the ability to retrieve a list of available submissions.
     */
    public CompletableFuture<DocusealClientHttpResponse<SubmissionList>> getSubmissions(RequestOptions requestOptions) {
     ...
     * The API endpoint provides the ability to retrieve a list of available submissions.
     */
    public CompletableFuture<DocusealClientHttpResponse<SubmissionList>> getSubmissions(GetSubmissionsParams request) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new DocusealClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SubmissionList.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * The API endpoint provides the functionality to retrieve information about a submission.
     */
    public CompletableFuture<DocusealClientHttpResponse<Submission>> getSubmission(
            int id, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<DocusealClientHttpResponse<SubmissionUpdateResult>> updateSubmission(int id) {
     ...
     */
    public CompletableFuture<DocusealClientHttpResponse<SubmissionArchiveResult>> archiveSubmission(int id) {
     ...
     */
    public CompletableFuture<DocusealClientHttpResponse<SubmissionDocuments>> getSubmissionDocuments(int id) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new DocusealClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SubmissionDocuments.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new DocusealClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, SubmissionCreateOneoffResult.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * The API endpoint provides functionality to retrieve information about a submitter, along with the submitter documents and field values.
     */
    public CompletableFuture<DocusealClientHttpResponse<Submitter>> getSubmitter(
            int id, RequestOptions requestOptions) {
     ...
     * The API endpoint provides functionality to retrieve information about a submitter, along with the submitter documents and field values.
     */
    public CompletableFuture<DocusealClientHttpResponse<Submitter>> getSubmitter(int id, GetSubmitterParams request) {
     ...
     */
    public CompletableFuture<DocusealClientHttpResponse<SubmitterUpdateResult>> updateSubmitter(int id) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new DocusealClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SubmitterUpdateResult.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * The API endpoint provides the ability to retrieve a list of submitters.
     */
    public CompletableFuture<DocusealClientHttpResponse<SubmitterList>> getSubmitters(RequestOptions requestOptions) {
     ...
     * The API endpoint provides the ability to retrieve a list of submitters.
     */
    public CompletableFuture<DocusealClientHttpResponse<SubmitterList>> getSubmitters(GetSubmittersParams request) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new DocusealClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SubmitterList.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<DocusealClientHttpResponse<Template>> updateTemplateDocuments(int id) {
     ...
     * The API endpoint allows you to clone an existing template into a new template.
     */
    public CompletableFuture<DocusealClientHttpResponse<Template>> cloneTemplate(
            int id, RequestOptions requestOptions) {
     ...
     * The API endpoint allows you to clone an existing template into a new template.
     */
    public CompletableFuture<DocusealClientHttpResponse<Template>> cloneTemplate(int id, CloneTemplateParams request) {
     ...
     */
    public CompletableFuture<DocusealClientHttpResponse<Template>> mergeTemplate(MergeTemplateParams request) {
    ...
    public CompletableFuture<DocusealClientHttpResponse<TemplatePermanentlyDeleteResult>> permanentlyDeleteTemplate(
        ...
        CompletableFuture<DocusealClientHttpResponse<TemplatePermanentlyDeleteResult>> future =
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new DocusealClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, TemplatePermanentlyDeleteResult.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
    ...
    public CompletableFuture<DocusealClientHttpResponse<SubmissionPermanentlyDeleteResult>> permanentlyDeleteSubmission(
        ...
        CompletableFuture<DocusealClientHttpResponse<SubmissionPermanentlyDeleteResult>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
