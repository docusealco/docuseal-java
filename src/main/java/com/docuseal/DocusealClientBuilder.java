...
public class DocusealClientBuilder {
     ...
     */
    public DocusealClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public DocusealClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public DocusealClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public DocusealClientBuilder logging(LogConfig logging) {
     ...
     */
    public DocusealClientBuilder addHeader(String name, String value) {
    ...
    public DocusealClient build() {
        ...
        return new DocusealClient(buildClientOptions());
    }
}
