...
@JsonDeserialize(using = SubmitterValueValueOneOfInner.SubmitterValueValueOneOfInnerDeserializer.class)
@JsonSerialize(using = SubmitterValueValueOneOfInner.SubmitterValueValueOneOfInnerSerializer.class)
public class SubmitterValueValueOneOfInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SubmitterValueValueOneOfInner.class.getName());

    public static class SubmitterValueValueOneOfInnerSerializer extends StdSerializer<SubmitterValueValueOneOfInner> {
        public SubmitterValueValueOneOfInnerSerializer(Class<SubmitterValueValueOneOfInner> t) {
            super(t);
        }

        public SubmitterValueValueOneOfInnerSerializer() {
            this(null);
        }

        @Override
        public void serialize(SubmitterValueValueOneOfInner value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SubmitterValueValueOneOfInnerDeserializer extends StdDeserializer<SubmitterValueValueOneOfInner> {
        public SubmitterValueValueOneOfInnerDeserializer() {
            this(SubmitterValueValueOneOfInner.class);
        }

        public SubmitterValueValueOneOfInnerDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public SubmitterValueValueOneOfInner deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                SubmitterValueValueOneOfInner ret = new SubmitterValueValueOneOfInner();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for SubmitterValueValueOneOfInner: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public SubmitterValueValueOneOfInner getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SubmitterValueValueOneOfInner cannot be null");
        }
    }
    ...
    public SubmitterValueValueOneOfInner() {
        super("oneOf", Boolean.FALSE);
    }

    public SubmitterValueValueOneOfInner(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SubmitterValueValueOneOfInner(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SubmitterValueValueOneOfInner(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(SubmitterValueValueOneOfInner.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return SubmitterValueValueOneOfInner.schemas;
    }
