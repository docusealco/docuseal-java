...
@JsonDeserialize(using = SubmitterValueValue.SubmitterValueValueDeserializer.class)
@JsonSerialize(using = SubmitterValueValue.SubmitterValueValueSerializer.class)
public class SubmitterValueValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SubmitterValueValue.class.getName());

    public static class SubmitterValueValueSerializer extends StdSerializer<SubmitterValueValue> {
        public SubmitterValueValueSerializer(Class<SubmitterValueValue> t) {
            super(t);
        }

        public SubmitterValueValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(SubmitterValueValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SubmitterValueValueDeserializer extends StdDeserializer<SubmitterValueValue> {
        public SubmitterValueValueDeserializer() {
            this(SubmitterValueValue.class);
        }

        public SubmitterValueValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public SubmitterValueValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                SubmitterValueValue ret = new SubmitterValueValue();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for SubmitterValueValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public SubmitterValueValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SubmitterValueValue cannot be null");
        }
    }
    ...
    public SubmitterValueValue() {
        super("oneOf", Boolean.FALSE);
    }

    public SubmitterValueValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SubmitterValueValue(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SubmitterValueValue(List<SubmitterValueValueOneOfInner> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SubmitterValueValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(SubmitterValueValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return SubmitterValueValue.schemas;
    }
