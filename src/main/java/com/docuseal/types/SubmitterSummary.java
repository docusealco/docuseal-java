...
@JsonDeserialize(
    builder = SubmitterSummary.Builder.class
)
public final class SubmitterSummary {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof SubmitterSummary && equalTo((SubmitterSummary) other);
  }
  ...
  private boolean equalTo(SubmitterSummary other) {
  ...
  public interface IdStage {
    ...
    Builder from(SubmitterSummary other);
  }
  ...
  public static final class Builder implements IdStage, SubmissionIdStage, UuidStage, SlugStage, CreatedAtStage, UpdatedAtStage, StatusStage, RoleStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(SubmitterSummary other) {
      id(other.getId());
    ...
    @java.lang.Override
    public SubmitterSummary build() {
      return new SubmitterSummary(id, submissionId, uuid, email, slug, sentAt, openedAt, completedAt, declinedAt, createdAt, updatedAt, name, phone, externalId, status, role, metadata, preferences, additionalProperties);
    }
  }
}
