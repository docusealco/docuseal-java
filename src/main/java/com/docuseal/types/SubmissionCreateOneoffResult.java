...
@JsonDeserialize(
    builder = SubmissionCreateOneoffResult.Builder.class
)
public final class SubmissionCreateOneoffResult {
  ...
  private SubmissionCreateOneoffResult(int id, String name, List<SubmitterCreateResult> submitters,
  ...
  public static final class Builder implements IdStage, NameStage, SourceStage, SubmittersOrderStage, StatusStage, CreatedAtStage, _FinalStage {
    ...
    public SubmissionCreateOneoffResult build() {
      return new SubmissionCreateOneoffResult(id, name, submitters, source, submittersOrder, status, schema, fields, expireAt, createdAt, additionalProperties);
    }
  }
}
