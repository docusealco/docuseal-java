...
public final class GetSubmissionResponseSubmitter {
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.submissionId, this.uuid, this.email, this.slug, this.sentAt, this.openedAt, this.completedAt, this.declinedAt, this.createdAt, this.updatedAt, this.name, this.phone, this.externalId, this.status, this.values, this.documents, this.role);
  }
