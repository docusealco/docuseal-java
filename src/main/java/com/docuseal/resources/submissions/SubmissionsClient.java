...
public class SubmissionsClient {
   ...
   * The API endpoint provides the functionality to retrieve information about a submission.
   */
  public GetSubmissionResponse getSubmission(int id, GetSubmissionRequest request) {
   ...
   * The API endpoint allows you to archive a submission.
   */
  public ArchiveSubmissionResponse archiveSubmission(int id, ArchiveSubmissionRequest request) {
