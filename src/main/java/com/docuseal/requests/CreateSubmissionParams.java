...
@JsonDeserialize(
    builder = CreateSubmissionParams.Builder.class
)
public final class CreateSubmissionParams {
  ...
  public static final class Builder implements TemplateIdStage, _FinalStage {
    ...
    public CreateSubmissionParams build() {
      return new CreateSubmissionParams(templateId, sendEmail, sendSms, order, completedRedirectUrl, bccCompleted, replyTo, expireAt, variables, message, submitters, additionalProperties);
    }
  }
}
