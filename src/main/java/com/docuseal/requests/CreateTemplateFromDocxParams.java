...
@JsonDeserialize(builder = CreateTemplateFromDocxParams.Builder.class)
public final class CreateTemplateFromDocxParams {
    ...
    private CreateTemplateFromDocxParams(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateTemplateFromDocxParams && equalTo((CreateTemplateFromDocxParams) other);
    }
    ...
    private boolean equalTo(CreateTemplateFromDocxParams other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CreateTemplateFromDocxParams other) {
            name(other.getName());
        ...
        public CreateTemplateFromDocxParams build() {
            return new CreateTemplateFromDocxParams(
                    name, externalId, folderName, sharedLink, documents, additionalProperties);
        }
