...
import com.docuseal.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncDocusealClientBuilder {
     ...
     */
    public AsyncDocusealClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncDocusealClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncDocusealClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncDocusealClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncDocusealClientBuilder addHeader(String name, String value) {
    ...
    protected void setAuthentication(ClientOptions.Builder builder) {
        if (this.apiKey != null) {
            builder.addHeader("X-Auth-Token", this.apiKey);
        }
    }
    ...
    public AsyncDocusealClient build() {
        ...
        return new AsyncDocusealClient(buildClientOptions());
    }
}
