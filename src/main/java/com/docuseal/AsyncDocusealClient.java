...
public class AsyncDocusealClient {
     ...
     */
    public AsyncDocusealClient(String apiKey) {
     ...
     */
    public AsyncDocusealClient(String apiKey, String url) {
     ...
     */
    public AsyncDocusealClient(String apiKey, Environment environment) {
    ...
    private static ClientOptions clientOptionsFrom(String apiKey, Environment environment) {
        ...
        AsyncDocusealClientBuilder builder = new AsyncDocusealClientBuilder().apiKey(apiKey);
        if (environment != null) {
     ...
     * The API endpoint provides the ability to retrieve a list of available document templates.
     */
    public CompletableFuture<TemplateList> getTemplates(RequestOptions requestOptions) {
     ...
     * The API endpoint provides the ability to retrieve a list of available document templates.
     */
    public CompletableFuture<TemplateList> getTemplates(GetTemplatesParams request, RequestOptions requestOptions) {
     ...
     * The API endpoint provides the functionality to retrieve information about a document template.
     */
    public CompletableFuture<Template> getTemplate(int id, RequestOptions requestOptions) {
     ...
     * The API endpoint provides the functionality to retrieve information about a document template.
     */
    public CompletableFuture<Template> getTemplate(int id, GetTemplateParams request, RequestOptions requestOptions) {
     ...
     * The API endpoint provides the functionality to move a document template to a different folder and update the name of the template.
     */
    public CompletableFuture<TemplateUpdateResult> updateTemplate(int id, RequestOptions requestOptions) {
        return this.rawClient.updateTemplate(id, requestOptions).thenApply(response -> response.body());
    }

    /**
     * The API endpoint provides the functionality to move a document template to a different folder and update the name of the template.
     */
    public CompletableFuture<TemplateUpdateResult> updateTemplate(int id, UpdateTemplateParams request) {
     ...
     * The API endpoint provides the functionality to move a document template to a different folder and update the name of the template.
     */
    public CompletableFuture<TemplateUpdateResult> updateTemplate(
     ...
     * The API endpoint allows you to archive a document template.
     */
    public CompletableFuture<TemplateArchiveResult> archiveTemplate(int id, RequestOptions requestOptions) {
        return this.rawClient.archiveTemplate(id, requestOptions).thenApply(response -> response.body());
    }

    /**
     * The API endpoint allows you to archive a document template.
     */
    public CompletableFuture<TemplateArchiveResult> archiveTemplate(int id, ArchiveTemplateParams request) {
     ...
     * The API endpoint allows you to archive a document template.
     */
    public CompletableFuture<TemplateArchiveResult> archiveTemplate(
     ...
     * The API endpoint provides the ability to retrieve a list of available submissions.
     */
    public CompletableFuture<SubmissionList> getSubmissions(RequestOptions requestOptions) {
        return this.rawClient.getSubmissions(requestOptions).thenApply(response -> response.body());
    }
     ...
     * The API endpoint provides the functionality to retrieve information about a submission.
     */
    public CompletableFuture<Submission> getSubmission(int id, RequestOptions requestOptions) {
        return this.rawClient.getSubmission(id, requestOptions).thenApply(response -> response.body());
    }
     ...
     * The API endpoint provides the functionality to retrieve information about a submission.
     */
    public CompletableFuture<Submission> getSubmission(
     ...
     * The API endpoint allows you to update a submission: change its name, expiration date, and archive or unarchive it.
     */
    public CompletableFuture<SubmissionUpdateResult> updateSubmission(int id, RequestOptions requestOptions) {
        return this.rawClient.updateSubmission(id, requestOptions).thenApply(response -> response.body());
    }

    /**
     * The API endpoint allows you to update a submission: change its name, expiration date, and archive or unarchive it.
     */
    public CompletableFuture<SubmissionUpdateResult> updateSubmission(int id, UpdateSubmissionParams request) {
     ...
     * The API endpoint allows you to update a submission: change its name, expiration date, and archive or unarchive it.
     */
    public CompletableFuture<SubmissionUpdateResult> updateSubmission(
     ...
     * The API endpoint allows you to archive a submission.
     */
    public CompletableFuture<SubmissionArchiveResult> archiveSubmission(int id, RequestOptions requestOptions) {
        return this.rawClient.archiveSubmission(id, requestOptions).thenApply(response -> response.body());
    }

    /**
     * The API endpoint allows you to archive a submission.
     */
    public CompletableFuture<SubmissionArchiveResult> archiveSubmission(int id, ArchiveSubmissionParams request) {
     ...
     * The API endpoint allows you to archive a submission.
     */
    public CompletableFuture<SubmissionArchiveResult> archiveSubmission(
     ...
     * This endpoint returns a list of partially filled documents for a submission. If the submission has been completed, the final signed documents are returned.
     */
    public CompletableFuture<SubmissionDocuments> getSubmissionDocuments(int id, RequestOptions requestOptions) {
        return this.rawClient.getSubmissionDocuments(id, requestOptions).thenApply(response -> response.body());
    }

    /**
     * This endpoint returns a list of partially filled documents for a submission. If the submission has been completed, the final signed documents are returned.
     */
    public CompletableFuture<SubmissionDocuments> getSubmissionDocuments(int id, GetSubmissionDocumentsParams request) {
     ...
     * This endpoint returns a list of partially filled documents for a submission. If the submission has been completed, the final signed documents are returned.
     */
    public CompletableFuture<SubmissionDocuments> getSubmissionDocuments(
     ...
     * The API endpoint provides functionality to retrieve information about a submitter, along with the submitter documents and field values.
     */
    public CompletableFuture<Submitter> getSubmitter(int id, RequestOptions requestOptions) {
        return this.rawClient.getSubmitter(id, requestOptions).thenApply(response -> response.body());
    }
     ...
     * The API endpoint provides functionality to retrieve information about a submitter, along with the submitter documents and field values.
     */
    public CompletableFuture<Submitter> getSubmitter(
     ...
     * The API endpoint allows you to update submitter details, pre-fill or update field values and re-send emails.<br><b>Related Guides</b><br><a href="https://www.docuseal.com/guides/pre-fill-pdf-document-form-fields-with-api#automatically_sign_documents_via_api" class="link">Automatically sign documents via API</a>
     */
    public CompletableFuture<SubmitterUpdateResult> updateSubmitter(int id, RequestOptions requestOptions) {
        return this.rawClient.updateSubmitter(id, requestOptions).thenApply(response -> response.body());
    }

    /**
     * The API endpoint allows you to update submitter details, pre-fill or update field values and re-send emails.<br><b>Related Guides</b><br><a href="https://www.docuseal.com/guides/pre-fill-pdf-document-form-fields-with-api#automatically_sign_documents_via_api" class="link">Automatically sign documents via API</a>
     */
    public CompletableFuture<SubmitterUpdateResult> updateSubmitter(int id, UpdateSubmitterParams request) {
     ...
     * The API endpoint allows you to update submitter details, pre-fill or update field values and re-send emails.<br><b>Related Guides</b><br><a href="https://www.docuseal.com/guides/pre-fill-pdf-document-form-fields-with-api#automatically_sign_documents_via_api" class="link">Automatically sign documents via API</a>
     */
    public CompletableFuture<SubmitterUpdateResult> updateSubmitter(
     ...
     * The API endpoint provides the ability to retrieve a list of submitters.
     */
    public CompletableFuture<SubmitterList> getSubmitters(RequestOptions requestOptions) {
        return this.rawClient.getSubmitters(requestOptions).thenApply(response -> response.body());
    }
     ...
     * The API endpoint provides the ability to retrieve a list of submitters.
     */
    public CompletableFuture<SubmitterList> getSubmitters(GetSubmittersParams request, RequestOptions requestOptions) {
     ...
     * The API endpoint allows you to add, remove or replace documents in the template with provided PDF/DOCX file or HTML content.
     */
    public CompletableFuture<Template> updateTemplateDocuments(int id, RequestOptions requestOptions) {
        return this.rawClient.updateTemplateDocuments(id, requestOptions).thenApply(response -> response.body());
    }

    /**
     * The API endpoint allows you to add, remove or replace documents in the template with provided PDF/DOCX file or HTML content.
     */
    public CompletableFuture<Template> updateTemplateDocuments(int id, UpdateTemplateDocumentsParams request) {
     ...
     * The API endpoint allows you to add, remove or replace documents in the template with provided PDF/DOCX file or HTML content.
     */
    public CompletableFuture<Template> updateTemplateDocuments(
     ...
     * The API endpoint allows you to clone an existing template into a new template.
     */
    public CompletableFuture<Template> cloneTemplate(int id, RequestOptions requestOptions) {
        return this.rawClient.cloneTemplate(id, requestOptions).thenApply(response -> response.body());
    }
     ...
     * The API endpoint allows you to clone an existing template into a new template.
     */
    public CompletableFuture<Template> cloneTemplate(
     ...
     * The API endpoint provides the functionality to seamlessly generate a PDF document template by utilizing the provided HTML content while incorporating pre-defined fields.<br><b>Related Guides</b><br><a href="https://www.docuseal.com/guides/create-pdf-document-fillable-form-with-html-api" class="link">Create PDF document fillable form with HTML</a>
     */
    public CompletableFuture<Template> createTemplateFromHtml(RequestOptions requestOptions) {
        return this.rawClient.createTemplateFromHtml(requestOptions).thenApply(response -> response.body());
    }
     ...
     * The API endpoint provides the functionality to create a fillable document template for an existing Microsoft Word document. Use <code>{{Field Name;role=Signer1;type=date}}</code> text tags to define fillable fields in the document. See <a href="https://www.docuseal.com/examples/fieldtags.docx" target="_blank" class="link font-bold" >https://www.docuseal.com/examples/fieldtags.docx</a> for more text tag formats. Or specify the exact pixel coordinates of the document fields using <code>fields</code> param.<br><b>Related Guides</b><br><a href="https://www.docuseal.com/guides/use-embedded-text-field-tags-in-the-pdf-to-create-a-fillable-form" class="link">Use embedded text field tags to create a fillable form</a>
     */
    public CompletableFuture<Template> createTemplateFromDocx(
     ...
     * The API endpoint provides the functionality to create a fillable document template for a PDF file. Use <code>{{Field Name;role=Signer1;type=date}}</code> text tags to define fillable fields in the document. See <a href="https://www.docuseal.com/examples/fieldtags.pdf" target="_blank" class="link font-bold">https://www.docuseal.com/examples/fieldtags.pdf</a> for more text tag formats. Or specify the exact pixel coordinates of the document fields using <code>fields</code> param.<br><b>Related Guides</b><br><a href="https://www.docuseal.com/guides/use-embedded-text-field-tags-in-the-pdf-to-create-a-fillable-form" class="link">Use embedded text field tags to create a fillable form</a>
     */
    public CompletableFuture<Template> createTemplateFromPdf(
     ...
     * The API endpoint allows you to merge multiple templates with documents and fields into a new combined template.
     */
    public CompletableFuture<Template> mergeTemplate(MergeTemplateParams request, RequestOptions requestOptions) {
     ...
     * The API endpoint allows you to permanently delete a document template and all of its submissions.
     */
    public CompletableFuture<TemplatePermanentlyDeleteResult> permanentlyDeleteTemplate(
     ...
     * The API endpoint allows you to permanently delete a submission and all of its submitters and documents.
     */
    public CompletableFuture<SubmissionPermanentlyDeleteResult> permanentlyDeleteSubmission(
            int id, RequestOptions requestOptions) {
